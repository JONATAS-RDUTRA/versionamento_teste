...
\restrict ODkctq2jTHkXEvsI5Jd83uSzUJNmZT16SZUGMpdWqbTVmZf0E0eZRfVApzJSXRw
...
CREATE VIEW public.vw_lista_compras_dinamica_grupo_filial AS
 SELECT vgcp.id_grupo,
   ...
   FROM (public.produtos_compras_filial vgcp
...
UNION
 SELECT t.id_grupo,
   ...
   FROM public.produtos_transito_filial t
...
\unrestrict ODkctq2jTHkXEvsI5Jd83uSzUJNmZT16SZUGMpdWqbTVmZf0E0eZRfVApzJSXRw
