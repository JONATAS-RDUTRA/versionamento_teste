CREATE OR REPLACE FUNCTION public.getsaldohorizontefuturo(idprod character varying)
 RETURNS numeric
 LANGUAGE plpgsql
AS $function$
declare 
...
begin 
    ...
    select getconsumo_transito(idprod),getcompra_transito(idprod),coalesce(estoque,0) 
