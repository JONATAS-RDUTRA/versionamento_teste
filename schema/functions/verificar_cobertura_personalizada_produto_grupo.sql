CREATE OR REPLACE FUNCTION public.verificar_cobertura_personalizada_produto_grupo(p_idgrupo integer, p_idproduto character varying)
 RETURNS boolean
 LANGUAGE plpgsql
AS $function$
DECLARE
...
BEGIN
    ...
    WHERE gf.id_grupo = p_idgrupo AND pf.idproduto = p_idproduto
    LIMIT 1;
