...
\restrict 0ECLycjuIHlzkVoc3ZeLNqE015efdZgz7RJ5Lg6QI6ndGim6WyVdFTO8TAnC6Cl
 ...
 SELECT id_grupo,
   ...
   FROM ( SELECT previsao.idfornecedor,
           ...
           FROM ( SELECT p.id_grupo,
                    ...
                    p.ponto_pedido,
                    public.get_forecast_grupo((p.id_grupo)::numeric, p.idproduto, (( SELECT f_1.tempo_forecast
                    ...
                    (public.get_arvore_decisao_grupo((p.id_grupo)::numeric, p.idproduto))::text AS arvore_decisao,
                    public.getnivelservico(public.get_arvore_decisao_grupo((p.id_grupo)::numeric, p.idproduto)) AS nivel_servico,
                    public.getpesocompras(public.get_arvore_decisao_grupo((p.id_grupo)::numeric, p.idproduto), ("substring"((public.get_arvore_decisao_grupo((p.id_grupo)::numeric, p.idproduto))::text, 3, 1))::numeric) AS peso_compras
...
\unrestrict 0ECLycjuIHlzkVoc3ZeLNqE015efdZgz7RJ5Lg6QI6ndGim6WyVdFTO8TAnC6Cl
